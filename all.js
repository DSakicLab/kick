...
if(mindist[n] == Infinity) { mindist[n] = 100; }
demo += ("Frag "+n+" minimal distance "+mindist[n]+"<br>");
//console.log("Frag "+n+" minimal distance "+mindist[n]);
var3[n] = somedist[n].indexOf(mindist[n]);
demo += ("Minimal between atoms "+var1[n][var3[n]]+" "+var2[n][var3[n]]+"<br>");
//console.log("Minimal between atoms "+var1[n][var3[n]]+" "+var2[n][var3[n]]);
if (var1[n][var3[n]] == undefined){var1[n][var3[n]] = 0;}
if (var2[n][var3[n]] == undefined){var2[n][var3[n]] = 1;}
//console.log("Minimal between atoms "+var1[n][var3[n]]+" "+var2[n][var3[n]]);
}

var firstToChange = mindist.indexOf(Math.min.apply(Math,mindist));
//console.log(var1[firstToChange][var3[firstToChange]]);
demo += ("<br>"+"First to change "+var1[firstToChange][var3[firstToChange]]+" "+var2[firstToChange][var3[firstToChange]]+"<br>");
//console.log("First to change "+var1[firstToChange][var3[firstToChange]]+" "+var2[firstToChange][var3[firstToChange]]);
